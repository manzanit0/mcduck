...
import (
	...
	context "context"
	errors "errors"
	users_v1 "github.com/manzanit0/mcduck/gen/api/users.v1"
	http "net/http"
	strings "strings"
)
...
var (
	usersServiceServiceDescriptor       = users_v1.File_api_users_v1_users_proto.Services().ByName("UsersService")
