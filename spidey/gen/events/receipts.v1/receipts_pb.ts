...
// @generated from file events/receipts.v1/receipts.proto (package events.receipts.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum events.receipts.v1.ListReceiptsSince
 */
...
proto3.util.setEnumType(ListReceiptsSince, "events.receipts.v1.ListReceiptsSince", [
...
/**
 * @generated from enum events.receipts.v1.ReceiptStatus
 */
...
proto3.util.setEnumType(ReceiptStatus, "events.receipts.v1.ReceiptStatus", [
...
/**
 * @generated from message events.receipts.v1.ReceiptCreated
 */
export class ReceiptCreated extends Message<ReceiptCreated> {
  /**
   * @generated from field: events.receipts.v1.Receipt receipt = 1;
   */
  receipt?: Receipt;
  ...
  static readonly typeName = "events.receipts.v1.ReceiptCreated";
...
/**
 * @generated from message events.receipts.v1.Receipt
 */
export class Receipt extends Message<Receipt> {
  ...
  /**
   * @generated from field: events.receipts.v1.ReceiptStatus status = 2;
   */
  ...
  /**
   * @generated from field: repeated events.receipts.v1.Expense expenses = 6;
   */
  expenses: Expense[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "events.receipts.v1.Receipt";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message events.receipts.v1.Expense
 */
export class Expense extends Message<Expense> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "events.receipts.v1.Expense";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
