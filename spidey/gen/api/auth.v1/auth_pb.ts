...
// @generated from file api/auth.v1/auth.proto (package api.auth.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class LoginRequest extends Message<LoginRequest> {
  ...
  static readonly typeName = "api.auth.v1.LoginRequest";
...
export class LoginResponse extends Message<LoginResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.auth.v1.LoginResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.auth.v1.RegisterRequest
 */
export class RegisterRequest extends Message<RegisterRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.auth.v1.RegisterRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "password", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message api.auth.v1.RegisterResponse
 */
export class RegisterResponse extends Message<RegisterResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.auth.v1.RegisterResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message api.auth.v1.ConnectTelegramRequest
 */
export class ConnectTelegramRequest extends Message<ConnectTelegramRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.auth.v1.ConnectTelegramRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message api.auth.v1.ConnectTelegramResponse
 */
export class ConnectTelegramResponse extends Message<ConnectTelegramResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.auth.v1.ConnectTelegramResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
