...
/**
 * @generated from enum api.receipts.v1.ListReceiptsSince
 */
...
proto3.util.setEnumType(ListReceiptsSince, "api.receipts.v1.ListReceiptsSince", [
...
/**
 * @generated from enum api.receipts.v1.ReceiptStatus
 */
...
/**
 * @generated from message api.receipts.v1.CreateReceiptsRequest
 */
export class CreateReceiptsRequest extends Message<CreateReceiptsRequest> {
  ...
  static readonly typeName = "api.receipts.v1.CreateReceiptsRequest";
...
/**
 * @generated from message api.receipts.v1.CreateReceiptsResponse
 */
...
/**
 * @generated from message api.receipts.v1.UpdateReceiptRequest
 */
export class UpdateReceiptRequest extends Message<UpdateReceiptRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.UpdateReceiptRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.receipts.v1.UpdateReceiptResponse
 */
export class UpdateReceiptResponse extends Message<UpdateReceiptResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.UpdateReceiptResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message api.receipts.v1.DeleteReceiptRequest
 */
export class DeleteReceiptRequest extends Message<DeleteReceiptRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.DeleteReceiptRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);
...
/**
 * @generated from message api.receipts.v1.DeleteReceiptResponse
 */
export class DeleteReceiptResponse extends Message<DeleteReceiptResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.DeleteReceiptResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message api.receipts.v1.ListReceiptsRequest
 */
export class ListReceiptsRequest extends Message<ListReceiptsRequest> {
  /**
   * @generated from field: api.receipts.v1.ListReceiptsSince since = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.ListReceiptsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.receipts.v1.Receipt
 */
export class Receipt extends Message<Receipt> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.Receipt";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "status", kind: "enum", T: proto3.getEnumType(ReceiptStatus) },
...
/**
 * @generated from message api.receipts.v1.Expense
 */
export class Expense extends Message<Expense> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.Expense";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
/**
 * @generated from message api.receipts.v1.ListReceiptsResponse
 */
export class ListReceiptsResponse extends Message<ListReceiptsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.ListReceiptsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.receipts.v1.GetReceiptRequest
 */
export class GetReceiptRequest extends Message<GetReceiptRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.GetReceiptRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);
...
/**
 * @generated from message api.receipts.v1.GetReceiptResponse
 */
export class GetReceiptResponse extends Message<GetReceiptResponse> {
  /**
   * @generated from field: api.receipts.v1.FullReceipt receipt = 1;
   */
  receipt?: FullReceipt;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.GetReceiptResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.receipts.v1.FullReceipt
 */
export class FullReceipt extends Message<FullReceipt> {
  ...
  /**
   * @generated from field: repeated api.receipts.v1.Expense expenses = 6;
   */
  expenses: Expense[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.receipts.v1.FullReceipt";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "status", kind: "enum", T: proto3.getEnumType(ReceiptStatus) },
    { no: 3, name: "vendor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
