...
/**
 * @generated from message api.expenses.v1.CreateExpenseRequest
 */
export class CreateExpenseRequest extends Message<CreateExpenseRequest> {
  ...
  static readonly typeName = "api.expenses.v1.CreateExpenseRequest";
...
/**
 * @generated from message api.expenses.v1.CreateExpenseResponse
 */
export class CreateExpenseResponse extends Message<CreateExpenseResponse> {
  /**
   * @generated from field: api.expenses.v1.Expense expense = 1;
   */
  expense?: Expense;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.CreateExpenseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.expenses.v1.UpdateExpenseRequest
 */
export class UpdateExpenseRequest extends Message<UpdateExpenseRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.UpdateExpenseRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.expenses.v1.UpdateExpenseResponse
 */
export class UpdateExpenseResponse extends Message<UpdateExpenseResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.UpdateExpenseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "expense", kind: "message", T: Expense },
  ]);
...
/**
 * @generated from message api.expenses.v1.DeleteExpenseRequest
 */
export class DeleteExpenseRequest extends Message<DeleteExpenseRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.DeleteExpenseRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);
...
/**
 * @generated from message api.expenses.v1.DeleteExpenseResponse
 */
export class DeleteExpenseResponse extends Message<DeleteExpenseResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.DeleteExpenseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message api.expenses.v1.ListExpensesRequest
 */
export class ListExpensesRequest extends Message<ListExpensesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.ListExpensesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.expenses.v1.ListExpensesResponse
 */
export class ListExpensesResponse extends Message<ListExpensesResponse> {
  /**
   * @generated from field: repeated api.expenses.v1.Expense expenses = 1;
   */
  expenses: Expense[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.ListExpensesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.expenses.v1.Expense
 */
export class Expense extends Message<Expense> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.expenses.v1.Expense";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "receipt_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */, opt: true },
